"""Transolver model for irregular-mesh CFD surrogates.

Based on https://arxiv.org/abs/2402.02366. Refactored out of train.py so
predict.py can import without triggering simple_parsing.
"""
