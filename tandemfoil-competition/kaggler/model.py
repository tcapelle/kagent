"""Transolver-based CFD surrogate model."""
...
class PhysicsAttention(nn.Module):
    """Physics-aware attention for irregular meshes (Transolver)."""
...
class TransolverBlock(nn.Module):
    def __init__(self, num_heads, hidden_dim, dropout, act="gelu",
                 mlp_ratio=2, last_layer=False, out_dim=3, slice_num=64):
        super().__init__()
