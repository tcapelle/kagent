"""Model definitions for the TandemFoilSet surrogate.

Transolver: physics-aware attention over irregular meshes via slice tokens.
...
class PhysicsAttention(nn.Module):
    ...
    def forward(self, x, mask=None):
        ...
        if mask is not None:
            # Padding nodes shouldn't contribute to slice tokens.
