...
class Config:
    ...
    # iter59: thorfinn 79f342d has NEW best re=34.2657. Route to it.
    # Per-split bests: single=V (35.0312), rc=my (48.5674), cruise=my (20.3564), re=X (34.2657).
    # Floor: (35.0312 + 48.5674 + 20.3564 + 34.2657)/4 = 34.5552
