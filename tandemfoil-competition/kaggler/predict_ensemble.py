"""Ensemble prediction: average preds across multiple checkpoints.

Run:
  python predict_ensemble.py --checkpoints "<path1>,<path2>,..." --agent <name>
"""
