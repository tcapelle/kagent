...
class Config:
    ...
    # iter86: thorfinn/052f014 (QQ) HUGE BREAKTHROUGH new floors on ALL splits.
    # Per-split-best: ALL=QQ. Avg = 34.1723.
    single: str = "thorfinnQQ:1.0"
    rc: str = "thorfinnQQ:1.0"
    cruise: str = "thorfinnQQ:1.0"
    re_rand: str = "thorfinnQQ:1.0"
