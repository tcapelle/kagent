"""Predict with FP32 (no bf16 autocast). Submits per-split.

Run:
  python predict_fp32.py --checkpoint <path> --agent thorfinn
"""
...
TEST_SPLITS = ["test_single_in_dist", "test_geom_camber_rc",
...
model.eval()
print(f"Loaded {cfg.checkpoint} (FP32 inference)")
...
print(f"\nFP32 predictions saved to {output_dir}")
