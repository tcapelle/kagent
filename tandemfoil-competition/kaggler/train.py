...
MODEL_CONFIG = dict(
    ...
    fun_dim=X_DIM - 2,
    out_dim=3,
    n_hidden=int(os.environ.get("MODEL_HIDDEN", 384)),
    n_layers=int(os.environ.get("MODEL_LAYERS", 8)),
    n_head=int(os.environ.get("MODEL_HEAD", 8)),
    slice_num=int(os.environ.get("MODEL_SLICE", 64)),
    mlp_ratio=int(os.environ.get("MODEL_MLP_RATIO", 2)),
